...
const SweetAlertHnadler = ({ hasBuyers, hasConcretes, hasCementStores, hasSandStoreSand, hasSandStoreGravel, hasWaterStore, hasMixers, hasDrivers }) => {
  ...
  if (!hasSandStoreSand) {
    alerts.push({
      icon: "warning",
      title: "<span style='color:red'>هشدار</span>",
      text: `هنوز هیچ سیلویی برای ماسه شسته ثبت نشده است. لازم است ابتدا سیلو را ثبت کنید. دقت کنید یک سیلو برای ماسه شسته و یک سیلو برای شن بادامی ثبت کنید.`,
      confirmButtonText: "  ثبت سیلو   ",
      showCancelButton: true,
      cancelButtonText: "کنسل",
      confirmButtonColor: "#3085d6",
  ...
  if (!hasSandStoreGravel) {
    alerts.push({
      icon: "warning",
      title: "<span style='color:red'>هشدار</span>",
      text: `هنوز هیچ سیلویی برای شن بادامی ثبت نشده است. لازم است ابتدا سیلو را ثبت کنید. دقت کنید یک سیلو برای ماسه شسته و یک سیلو برای شن بادامی ثبت کنید.`,
      confirmButtonText: "  ثبت سیلو   ",
      showCancelButton: true,
      cancelButtonText: "کنسل",
      confirmButtonColor: "#3085d6",
