...
REM Open waiting page in Chrome app mode
echo Opening waiting page...
start /min chrome.exe --app=file:///%cd%/loading.html
timeout /t 5
...
REM Close waiting page
echo Closing waiting page...
taskkill /F /IM chrome.exe

REM Open Chrome browser in app mode with main application
echo Opening main application in Chrome app mode...
