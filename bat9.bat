...
powershell -Command "$WScriptShell = New-Object -ComObject WScript.Shell; $Shortcut = $WScriptShell.CreateShortcut('%SHORTCUT_PATH%'); $Shortcut.TargetPath = 'C:\Program Files\Google\Chrome\Application\chrome.exe'; $Shortcut.Arguments = '--app=http://localhost:8000'; $Shortcut.IconLocation = '%ICON_PATH%'; $Shortcut.Save()"
