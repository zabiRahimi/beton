...
REM Start XAMPP
echo Starting XAMPP...
start "" nircmd.exe exec hide "C:\xampp\xampp_start.exe"
...
nircmd.exe exec hide start "" cmd /c "cd C:\xampp\htdocs\beton && yarn dev"
...
nircmd.exe exec hide start "" cmd /c "cd C:\xampp\htdocs\beton && php -S localhost:8000 -t public"
...
nircmd.exe exec hide start "" chrome.exe --app=http://localhost:8000
